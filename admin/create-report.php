<div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
    <div class="border-4 col-span-1 md:col-span-4 border-solid  border-gray-900 bg-white h-auto mb-4">
        <form class="py-5 px-6" method="post" enctype="multipart/form-data">
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-base/7 font-semibold text-gray-900"> Create Report</h2>
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full">
                                    <input type="text" name="title" id="title" class="ml-4 block w-full border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm" placeholder="Type in your title here...">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-span-full">
                            ...
                            <p class="mt-3 text-sm/6 text-gray-600">Write about the content of your report.</p>
                        </div>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button name="submit" type="submit" class=" bg-[#F7C236] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#F7D47A] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
            </div>
        </form>
