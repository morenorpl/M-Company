<!-- Sidebar -->
<aside class="scrollbar fixed top-0 left-0 z-40 w-72 lg:w-56 h-screen pt-14 transition-transform -translate-x-full bg-white border-r-4 border-[#0C0D0F] lg:translate-x-0" aria-label="Sidenav" id="drawer-navigation">
    <div class="overflow-y-auto py-5 px-3 h-full bg-[#AAD7B8]">
        <!-- Menu (It's for mobile) -->
        <ul class="space-y-0.5 inline lg:hidden">
            <li>
                <a href="index.php?page=dashboard" class="flex items-center p-2 text-base font-medium text-primary hover:bg-[#0C0D0F] group transition duration-75">
                    <svg class="w-6 h-6 text-gray-900 group-hover:text-white transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <li>
                <a href="index.php?page=users" class="flex items-center p-2 text-base font-medium text-primary hover:bg-[#0C0D0F] group transition duration-75">
                    <svg class="w-6 h-6 text-gray-900 group-hover:text-white transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="index.php?page=reports" class="flex items-center p-2 text-base font-medium text-primary hover:bg-[#0C0D0F] group transition duration-75">
                    <svg class="w-6 h-6 text-gray-900 group-hover:text-white transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="index.php?page=list" class="flex items-center p-2 text-base font-medium text-primary hover:bg-[#0C0D0F] group transition duration-75">
                    <svg class="w-6 h-6 text-gray-900 group-hover:text-white transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-[#AAD7B8] z-20">
